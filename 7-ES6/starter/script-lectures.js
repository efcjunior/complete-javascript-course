...
var personClass5 = new PersonClass5('john', 1986, 'teacher');
personClass5.calculateAge();
...
const personClass6 = new PersonClass6('john', 1986, 'teacher');
personClass6.calculateAge();

PersonClass6.greeting();
/*
Notes:

1) The class definitions are not hoisted. Unlike function constructors, we need to first implement a class, 
and only later in our code we can start using it.

2) We can only add methods, but not properties
*/

//-------------------------------------------------------------------------------------------------------------------------

// Lecture: class and sub class
...
var johnAthlete5 = new Athlete5('john', 1988, 'swimmer', 3, 10);
johnAthlete5.calculateAge();
johnAthlete5.wonMedal();

var Athlete52 = function (name, yearOfBirth, job, olymicGames, medals){
    Athlete5.call(this, name, yearOfBirth, job, olymicGames, medals);
}

Athlete52.prototype = Object.create(Athlete5.prototype);

var johnAthlete52 = new Athlete52('everson', 1997, 'soccer', 4, 5);
johnAthlete52.calculateAge();
johnAthlete52.wonMedal();

//ES6
class Athlete6 extends PersonClass6 {
...
const johnAthlete6 = new Athlete6('john6', 1995, 'swimmer', 3, 20);
